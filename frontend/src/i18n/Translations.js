...
const translations = {
  en: {
    ...
    gameUI: {
      ...
      kickoffGo: "GO!",
      missileReady: "🚀 Homing missile armed! Press SPACE to fire it at the rival ball carrier",
  ...
  es: {
    ...
    gameUI: {
      ...
      kickoffGo: "¡YA!",
      missileReady: "🚀 ¡Misil teledirigido armado! Pulsa ESPACIO para dispararlo al rival con balón",
