...
const translations = {
  en: {
    ...
    teamSelection: {
      ...
      botBehaviorTitle: "Bot AI logic",
      botBehaviorDesc: "• Defensive coverage (one presses, one covers)\n• Picks up speed/missile items\n• Tactical passes under pressure\n• Harder to steal from behind",
  ...
  es: {
    ...
    teamSelection: {
      ...
      botBehaviorTitle: "Lógica del bot (IA)",
      botBehaviorDesc: "• Cobertura defensiva (uno presiona, otro cubre)\n• Recoge ítems de velocidad y misiles\n• Pases tácticos bajo presión\n• Más difícil de robarle por detrás",
